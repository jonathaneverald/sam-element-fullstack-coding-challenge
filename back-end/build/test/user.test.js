...
describe("POST /api/users/login", () => {
    ...
    it("should reject the login if the username is wrong", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(web_1.web).post("/api/users/login").send({
            username: "wrong",
            password: "test",
        });
    ...
    it("should reject the login if the password is wrong", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(web_1.web).post("/api/users/login").send({
            username: "test",
            password: "wrong",
        });
...
describe("GET /api/users/current", () => {
    ...
    it("should not be able to get current user", () => __awaiter(void 0, void 0, void 0, function* () {
...
describe("PATCH /api/users/current", () => {
    ...
    it("should reject update user if request is invalid", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(web_1.web).patch("/api/users/current").set("X-API-TOKEN", "test").send({
            name: "",
            password: "",
        });
        logging_1.logger.debug(response.body);
    ...
    it("should reject update user if token is invalid", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(web_1.web).patch("/api/users/current").set("X-API-TOKEN", "wrong").send({
            name: "test",
            password: "test",
        });
        logging_1.logger.debug(response.body);
    ...
    it("should be able update user password", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(yield bcrypt_1.default.compare("newTest", user.password)).toBe(true);
    }));
});
describe("DELETE /api/users/current", () => {
    ...
    it("should be able to logout", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(web_1.web).delete("/api/users/current").set("X-API-TOKEN", "test");
        logging_1.logger.debug(response.body);
        expect(response.status).toBe(200);
    ...
    it("should not be able to logout if token is incorrect", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(web_1.web).delete("/api/users/current").set("X-API-TOKEN", "wrong");
        logging_1.logger.debug(response.body);
        expect(response.status).toBe(401);
        expect(response.body.errors).toBeDefined;
    }));
